...
const CustomerTicket = ({ ticket }) => {
  ...
  return (
    <div className="ticket-card bg-white p-6 rounded-lg shadow-md w-[500px]">
      <div>
        ...
        <div className="flex gap-10 mt-2">
          ...
          <p className={`text-gray-500 ${getPriorityColor(ticket.priority)} text-sm`}>
            {ticket.priority.toUpperCase()}
          </p>
          <p className="text-gray-500 text-sm">{ticket.assignee}</p>
          <p className="text-gray-500 flex items-center">
            <img src={Calender} alt="Calendar" className="inline-block mr-1 w-[20px] h-[20px]" />
